---
name: punchout
description: "하루 마무리 도장 — day-query 결과를 org-mode 형식으로 오늘 저널에 삽입. 하루 마무리 시 '/punchout' 한 번이면 끝. Use when user says 'punchout', '퇴근', '오늘 마무리', '하루 마무리', 'punch out', '도장', or wants a daily summary written to journal."
user_invocable: true
---
